...
def itachis2p1():
    ...
    if keys[105] and p1chakra>=40: #starts when the condition is met
        p1chakra-=40
...
while running:
    ...
    ########################## Player 1 #####################################
        if p1softhurt==False and p1fallstatus==False:   # If character is not hurt or fallen, character can operate
            ...
            if keys[115] and p1ground==True:#Chakra Charge S Key
                p1chakra+=1 
    ...
    ######################### Player 2 ######################################
        if p2softhurt==False and p2fallstatus==False: #same for player 2
            ...
            if keys[K_DOWN] and p2ground==True:
                p2chakra+=1
